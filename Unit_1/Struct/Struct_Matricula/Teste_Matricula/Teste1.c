...
/*int aluno_matriculado(Turma* turma, int mat, char* nome){
    ...
    for(indice = 0; indice < MAX_VAGAS; indice++){
        if(nome == turma->alunos[indice]->nome){
            vaga_aluno = 0;
...
int main(void){
    ...
    case 3:
        ...
        Turma * turma = procurar_turma(turmas, id_turma, contador);
        if( turma != 0){
    ...
    case 4:
        ...
        Turma * turma_notas = procurar_turma(turmas, id_turma, contador);
        if( turma_notas != 0){
    ...
    case 5:
        ...
        Turma * turma_alunos = procurar_turma(turmas, id_turma, contador);
        if( turma_notas != 0){
            imprime_alunos(turma_notas);
        }else{
            printf("Turma nao existe!\n");
        }
    ...
    case 7:
        ...
        printf("Procurando turma...\n");
        printf("Digite o id da turma: ");
        scanf(" %c", &id_turma);
        Turma* turma_x = procura_turma(turmas, contador, id_turma);

        funcao_turma(turma_x);
